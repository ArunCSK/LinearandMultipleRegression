...
storage_account_name = "week6storage"
...
file_location = "wasbs://week6container@week6storage.blob.core.windows.net"+FilePath+"/"+filename
print(file_location)
file_type = "csv"
...
dbutils.fs.mount(
  source = "wasbs://week6container@week6storage.blob.core.windows.net",
